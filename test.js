...
tape('flix.departures', async t => {
	const deps = await flix.departures(berlinAlexanderplatz)
...
tape('flix.arrivals', async t => {
	const arrs = await flix.arrivals(berlinAlexanderplatz)
